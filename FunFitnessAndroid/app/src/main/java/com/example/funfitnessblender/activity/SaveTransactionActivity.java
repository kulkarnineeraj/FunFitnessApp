    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        backBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(SaveTransactionActivity.this, MainActivity.class);
        ...
        transactionRef.child(transactionId).setValue(transaction)
                .addOnCompleteListener(task -> {
                    if (task.isSuccessful()) {
                        ...
                        Intent intent = new Intent(SaveTransactionActivity.this, AllTransactionActivity.class);
                        startActivity(intent);
                    } else {
