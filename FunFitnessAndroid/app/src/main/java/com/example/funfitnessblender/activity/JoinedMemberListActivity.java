...
public class JoinedMemberListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_joined_member_list);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(JoinedMemberListActivity.this, DetailedDataActivity.class);
        ...
        backBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(JoinedMemberListActivity.this, MainActivity.class);
                startActivity(intent);
            }
        });
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                    ...
                    if (client != null && client.getInterest() != null && "Joined".equalsIgnoreCase(client.getInterest())) {
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Log.e("JoinedMemberListActivity", "Failed to retrieve data", databaseError.toException());
            }
        });
    }
